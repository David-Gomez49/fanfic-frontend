...
import { useFic, useRateFic, useToggleFavorite, useToggleReadLater, useAddComment, useRefreshFic } from "@/hooks/use-fics";
import { useAuth } from "@/lib/auth-context";
import { FicDetailSkeleton } from "@/components/fic-card-skeleton";
import { FicStatsBar } from "@/components/fic-stats-bar";
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            genre: ficData.fandoms,
            keywords: ficData.tags?.join(", "),
            inLanguage: ficData.language,
            datePublished: ficData.publishedAt,
            dateModified: ficData.externalUpdatedAt ?? ficData.createdAt,
            wordCount: ficData.words,
            ...(avgRating > 0 && {
              aggregateRating: {
